...
/// <summary>
/// Only one InputController can be on scene
/// Singleton InputController, that calls Action when 
/// 1. Joystick is being moved
/// 2. Jump and Shoot buttons are being pressed
/// </summary>
